...
wget -q --no-cache https://raw.githubusercontent.com/88plug/akash-provider-tools/main/kubespray-bootstrap.sh
...
wget -q --no-cache https://raw.githubusercontent.com/88plug/akash-provider-tools/main/microk8s-bootstrap.sh
...
if [[ $METHOD_ == "k3s" ]]; then
wget -q --no-cache https://raw.githubusercontent.com/88plug/akash-provider-tools/main/k3s-bootstrap.sh
