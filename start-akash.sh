...
curl -s -H 'Cache-Control: no-cache' https://raw.githubusercontent.com/88plug/akash-provider-tools/main/kubespray-bootstrap.sh
...
curl -s -H 'Cache-Control: no-cache' https://raw.githubusercontent.com/88plug/akash-provider-tools/main/microk8s-bootstrap.sh
...
if [[ $METHOD_ == "k3s" ]]; then
curl -s -H 'Cache-Control: no-cache' https://raw.githubusercontent.com/88plug/akash-provider-tools/main/k3s-bootstrap.sh
